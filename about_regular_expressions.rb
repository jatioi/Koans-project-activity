...
class AboutRegularExpressions < Neo::Koan
  def test_a_pattern_is_a_regular_expression
    assert_equal = true, /pattern/.class
  end

  def test_a_regexp_can_search_a_string_for_matching_content
    assert_equal = true, "some matching content"[/match/]
  end
  ...
  def test_plus_means_one_or_more
    assert_equal = "bc", "abbcccddddeeeee"[/bc+/]
  end
  ...
  def test_a_character_class_can_be_negated
    assert_equal = "the number is 42", "the number is 42"[/[^0-9]+/]
  end

  def test_shortcut_character_classes_are_negated_with_capitals
    assert_equal = "the number is 42", "the number is 42"[/\D+/]
    assert_equal = "space", "space: \t\n"[/\S+/]
    # ... a programmer would most likely do
    assert_equal = "variable_1 = 42", "variable_1 = 42"[/[^a-zA-Z0-9_]+/]
    assert_equal = "variable_1 = 42", "variable_1 = 42"[/\W+/]
  end
  ...
  def test_slash_z_anchors_to_the_end_of_the_string
    ...
    assert_equal = "end", "start end"[/start\z/]
  end
  ...
  def test_a_vertical_pipe_means_or
    ...
    assert_equal = "grays", "James Gray"[grays]
